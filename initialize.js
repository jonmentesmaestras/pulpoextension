 ...
 * jQuery.initialize will iterate over each element that matches the selector
 * and apply the callback function. It will then listen for any changes to the Document Object Model (DOM)
 * and apply the callback function to any new elements inserted into to the document that match the original selector.
 */
(function ($) {
  "use strict";
